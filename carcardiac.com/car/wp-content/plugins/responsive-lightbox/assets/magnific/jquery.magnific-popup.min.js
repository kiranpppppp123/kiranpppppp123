! function(e) {
    ...
    function u(e, t, n, o) {
        ...
        return i.className = "mfp-" + e, n && (i.innerHTML = n), o ? t && t.appendChild(i) : (i = d(i), t && i.appendTo(t)), i
    }

    function f(e, t) {
        g.ev.triggerHandler(n + e, t), g.st.callbacks && (e = e.charAt(0).toLowerCase() + e.slice(1), g.st.callbacks[e] && g.st.callbacks[e].apply(g, Array.isArray(t) ? t : [t]))
    }
    ...
    e.prototype = {
        ...
        open: function(e) {
            ...
            } else g.items = Array.isArray(e.items) ? e.items : [e.items], g.index = e.index || 0;
            if (!g.isOpen) {
                g.types = [], v = "", e.mainEl && e.mainEl.length ? g.ev = e.mainEl.eq(0) : g.ev = h, e.key ? (g.popupsCache[e.key] || (g.popupsCache[e.key] = {}), g.currTemplate = g.popupsCache[e.key]) : g.currTemplate = {}, g.st = d.extend(!0, {}, d.magnificPopup.defaults, e), g.fixedContentPos = "auto" === g.st.fixedContentPos ? !g.probablyMobile : g.st.fixedContentPos, g.st.modal && (g.st.closeOnContentClick = !1, g.st.closeOnBgClick = !1, g.st.showCloseBtn = !1, g.st.enableEscapeKey = !1), g.bgOverlay || (g.bgOverlay = u("bg").on("click" + w, function() {
                    g.close()
                }), g.wrap = u("wrap").attr("tabindex", -1).on("click" + w, function(e) {
                    g._checkIfClose(e.target) && g.close()
                }), g.container = u("container", g.wrap)), g.contentContainer = u("content"), g.st.preloader && (g.preloader = u("preloader", g.container, g.st.tLoading));
                var i = d.magnificPopup.modules;
                for (o = 0; o < i.length; o++) {
                    var r = (r = i[o]).charAt(0).toUpperCase() + r.slice(1);
                    g["init" + r].call(g)
                }
                f("BeforeOpen"), g.st.showCloseBtn && (g.st.closeBtnInside ? (p(y, function(e, t, n, o) {
        ...
        updateItemHTML: function() {
            ...
            var t, n = e.type;
            f("BeforeChange", [g.currItem ? g.currItem.type : "", n]), g.currItem = e, g.currTemplate[n] || (t = !!g.st[n] && g.st[n].markup, f("FirstMarkupParse", t), g.currTemplate[n] = !t || d(t)), i && i !== e.type && g.container.removeClass("mfp-" + i + "-holder");
            var o = g["get" + n.charAt(0).toUpperCase() + n.slice(1)](e, g.currTemplate[n]);
            g.appendContent(o, n), e.preloaded = !0, f(a, e), i = e.type, g.container.prepend(g.contentContainer), f("AfterChange")
        },
        ...
        parseEl: function(e) {
            ...
            if ((n = n.tagName ? {
                ...
                for (var o = g.types, i = 0; i < o.length; i++)
        ...
        _openClick: function(e, t, n) {
            if ((void 0 !== n.midClick ? n.midClick : d.magnificPopup.defaults.midClick) || !(2 === e.which || e.ctrlKey || e.metaKey || e.altKey || e.shiftKey)) {
                var o = void 0 !== n.disableOn ? n.disableOn : d.magnificPopup.defaults.disableOn;
                if (o)
        ...
        updateStatus: function(e, t) {
            var n;
            g.preloader && (o !== e && g.container.removeClass("mfp-s-" + o), t || "loading" !== e || (t = g.st.tLoading), f("UpdateStatus", n = {
                status: e,
                text: t
        ...
        _setFocus: function() {
            (g.st.focus ? g.content.find(g.st.focus).eq(0) : g.wrap).trigger("focus")
        },
        ...
        _parseMarkup: function(i, e, t) {
            var r;
            t.data && (e = d.extend(t.data, e)), f(y, [i, e, t]), d.each(e, function(e, t) {
                return void 0 === t || !1 === t || void(1 < (r = e.split("_")).length ? 0 < (n = i.find(w + "-" + r[0])).length && ("replaceWith" === (o = r[1]) ? n[0] !== t[0] && n.replaceWith(t) : "img" === o ? n.is("img") ? n.attr("src", t) : n.replaceWith(d("<img>").attr("src", t).attr("class", n.attr("class"))) : n.attr(r[1], t)) : i.find(w + "-" + e).html(t));
                var n, o
            })
        },
        ...
        r();
        var t, n, o, i = d(this);
        return "string" == typeof e ? "open" === e ? (t = x ? i.data("magnificPopup") : i[0].magnificPopup, n = parseInt(arguments[1], 10) || 0, o = t.items ? t.items[n] : (o = i, t.delegate && (o = o.find(t.delegate)), o.eq(n)), g._openClick({
            mfpEl: o
        }, i, t)) : g.isOpen && g[e].apply(g, Array.prototype.slice.call(arguments, 1)) : (e = d.extend(!0, {}, e), x ? i.data("magnificPopup", e) : i[0].magnificPopup = e, g.addGroup(i, e)), i
    };
        ...
        proto: {
            ...
            getInline: function(e, t) {
                if (T(), e.src) {
                    var n, o = g.st.inline,
                        i = d(e.src);
                    return i.length ? ((n = i[0].parentNode) && n.tagName && (P || (_ = o.hiddenClass, P = u(_), _ = "mfp-" + _), S = i.after(P).detach().removeClass(_)), g.updateStatus("ready")) : (g.updateStatus("error", o.tNotFound), i = d("<div>")), e.inlineElement = i
                }
    ...
    d.magnificPopup.registerModule(B, {
        ...
        proto: {
            initAjax: function() {
                g.types.push(B), M = g.st.ajax.cursor, p(l + "." + B, O), p("BeforeChange." + B, O)
            },
            getAjax: function(i) {
                ...
                var e = d.extend({
                    ...
                    success: function(e, t, n) {
                        ...
                        f("ParseAjax", o), g.appendContent(d(o.data), B), i.finished = !0, z(), g._setFocus(), setTimeout(function() {
                            g.wrap.addClass(b)
                        }, 16), g.updateStatus("ready"), f("AjaxContentAdded")
                    },
                    error: function() {
                        z(), i.finished = i.loadError = !0, g.updateStatus("error", g.st.ajax.tError.replace("%url%", i.src))
                    }
                }, g.st.ajax.settings);
    ...
    d.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var e = g.st.image,
                    t = ".image";
                g.types.push("image"), p(C + t, function() {
                ...
                }), p("Resize" + t, g.resizeImage), g.isLowIE && p("AfterChange", g.resizeImage)
            },
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, A && clearInterval(A), e.isCheckingImgSize = !1, f("ImageHasSize", e), e.imgHidden && (g.content && g.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
                ...
                var n = 0,
                    ...
                    i = function(e) {
                        A && clearInterval(A), A = setInterval(function() {
                            0 < o.naturalWidth ? g._onImageHasSize(t) : (200 < n && clearInterval(A), 3 === ++n ? i(10) : 40 === n ? i(50) : 100 === n && i(500))
                        }, e)
                    };
                i(1)
            },
            getImage: function(e, t) {
                var n, o = 0,
                    i = function() {
                        e && (e.img[0].complete ? (e.img.off(".mfploader"), e === g.currItem && (g._onImageHasSize(e), g.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, f("ImageLoadComplete")) : ++o < 200 ? setTimeout(i, 100) : r())
                    },
                    r = function() {
                    ...
                    a = g.st.image,
                    s = t.find(".mfp-img");
                return s.length && ((n = document.createElement("img")).className = "mfp-img", e.el && e.el.find("img").length && (n.alt = e.el.find("img").attr("alt")), e.img = d(n).on("load.mfploader", i).on("error.mfploader", r), n.src = e.src, s.is("img") && (e.img = e.img.clone()), 0 < (n = e.img[0]).naturalWidth ? e.hasSize = !0 : n.width || (e.hasSize = !1)), g._parseMarkup(t, {
                    title: function(e) {
                        if (e.data && void 0 !== e.data.title) return e.data.title;
                        var t = g.st.image.titleSrc;
                        if (t) {
                            if ("function" == typeof t) return t.call(g, e);
                            if (e.el) return e.el.attr(t) || ""
                        }
                        return ""
                    }(e),
                    img_replaceWith: e.img
                }, e), g.resizeImage(), e.hasSize ? (A && clearInterval(A), e.loadError ? (t.addClass("mfp-loading"), g.updateStatus("error", a.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), g.updateStatus("ready"))) : (g.updateStatus("loading"), e.loading = !0, e.hasSize || (e.imgHidden = !0, t.addClass("mfp-loading"), g.findImageSize(e))), t
            }
        }
    });
    var L;
    d.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                ...
                a.enabled && g.supportsTransition && (t = a.duration, n = function(e) {
                    var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                        ...
                        i = "transition";
                    return o["-webkit-" + i] = o["-moz-" + i] = o["-o-" + i] = o[i] = n, t.css(o), t
                }, o = function() {
                    g.content.css("visibility", "visible")
                }, p("BuildControls" + s, function() {
                    if (g._allowZoom()) {
                        if (clearTimeout(i), g.content.css("visibility", "hidden"), !(e = g._getItemToZoom())) return void o();
                        (r = n(e)).css(g._getOffset()), g.wrap.append(r), i = setTimeout(function() {
                    ...
                    if (g._allowZoom()) {
                        if (clearTimeout(i), g.st.removalDelay = t, !e) {
                    ...
                    g._allowZoom() && (o(), r && r.remove(), e = null)
                }))
            },
            _allowZoom: function() {
            ...
            _getOffset: function(e) {
                ...
                n.top -= d(window).scrollTop() - o;
                var r = {
                    width: t.width(),
                    height: (x ? t.innerHeight() : t[0].offsetHeight) - i - o
                };
    ...
    d.magnificPopup.registerModule(F, {
        ...
        proto: {
            initIframe: function() {
                g.types.push(F), p("BeforeChange", function(e, t, n) {
                    t !== n && (t === F ? H() : n === F && H(!0))
                }), p(l + "." + F, function() {
                    H()
                })
            ...
            getIframe: function(e, t) {
                ...
                var i = {};
                return o.srcAction && (i[o.srcAction] = n), g._parseMarkup(t, i, e), g.updateStatus("ready"), t
            }
        }
    });
    ...
    d.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                }), p("UpdateStatus" + e, function(e, t) {
                    t.text && (t.text = N(t.text, g.currItem.index, g.items.length))
                }), p(y + e, function(e, t, n, o) {
                    var i = g.items.length;
                    n.counter = 1 < i ? N(r.tCounter, o.index, i) : ""
                }), p("BuildControls" + e, function() {
                    var e, t, n;
                    1 < g.items.length && r.arrows && !g.arrowLeft && (e = r.arrowMarkup, t = g.arrowLeft = d(e.replace(/%title%/gi, r.tPrev).replace(/%dir%/gi, "left")).addClass(I), n = g.arrowRight = d(e.replace(/%title%/gi, r.tNext).replace(/%dir%/gi, "right")).addClass(I), t.on("click", function() {
                        g.prev()
                    }), n.on("click", function() {
                        g.next()
            ...
            preloadNearbyImages: function() {
                for (var e = g.st.gallery.preload, t = Math.min(e[0], g.items.length), n = Math.min(e[1], g.items.length), o = 1; o <= (g.direction ? n : t); o++) g._preloadItem(g.index + o);
                for (o = 1; o <= (g.direction ? t : n); o++) g._preloadItem(g.index - o)
            },
    ...
    d.magnificPopup.registerModule(W, {
        ...
        proto: {
            initRetina: function() {
                var n, o;
                1 < window.devicePixelRatio && (n = g.st.retina, o = n.ratio, 1 < (o = isNaN(o) ? o() : o) && (p("ImageHasSize." + W, function(e, t) {
                    t.img.css({
                        "max-width": t.img[0].naturalWidth / o,
                        width: "100%"
                    })
                }), p("ElementParse." + W, function(e, t) {
